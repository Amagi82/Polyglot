...
//        const val path = "/languages"
         ...
         */
//        val names: MutableMap<LanguageIsoCode, String> = Json.decodeFromString("")
           /* mutableMapOf<LanguageIsoCode, String>().apply {
            put("en", "English")
            put("fr", "French")
            put("es", "Spanish")
            put("de", "German")
        ...
        /**
         * @param isoCode: Language isoCode, e.g. en, es, fr
         * @return list of region isoCodes where the language is spoken
         */
//        fun regionCodes(isoCode: LanguageIsoCode) = regions[isoCode]

//        val regions: MutableMap<LanguageIsoCode, List<RegionIsoCode>> = Json.decodeFromString("")
            /*mutableMapOf<LanguageIsoCode, List<RegionIsoCode>>().apply {
            put("af", listOf("NA", "ZA"))
            put("agq", listOf("CM"))
            put("ak", listOf("GH"))
            put("am", listOf("ET"))
